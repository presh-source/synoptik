...
APPSYNC_ENDPOINT = os.environ.get("APPSYNC_GRAPHQL_ENDPOINT")
...
def publish_crawler_completed(
    ...
    Raises:
        ValueError: If APPSYNC_GRAPHQL_ENDPOINT is not configured
        Exception: If all retry attempts fail
    """

    if not APPSYNC_ENDPOINT:
        error_msg = "APPSYNC_GRAPHQL_ENDPOINT environment variable not set"
